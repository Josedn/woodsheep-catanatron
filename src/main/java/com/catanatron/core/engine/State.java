...
public class State {
    ...
    public final java.util.Map<PlayerColor, Integer> lastInitialSettlement = new java.util.HashMap<>();
    // Dev cards
    ...
    public State(List<Player> players) {
        ...
        for (int i=0;i<2;i++) developmentDeck.add(com.catanatron.core.model.DevCard.YEAR_OF_PLENTY);
        for (int i=0;i<2;i++) developmentDeck.add(com.catanatron.core.model.DevCard.ROAD_BUILDING);
        for (int i=0;i<2;i++) developmentDeck.add(com.catanatron.core.model.DevCard.MONOPOLY);
        for (int i=0;i<5;i++) developmentDeck.add(com.catanatron.core.model.DevCard.VICTORY_POINT);
    ...
    public PlayerColor currentColor() { return colors.get(currentPlayerIndex); }
