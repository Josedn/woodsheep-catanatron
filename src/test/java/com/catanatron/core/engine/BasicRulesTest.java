...
public class BasicRulesTest {
    ...
    public void distanceRuleBlocksNeighbors() {
        ...
        int node = game.state.board.buildableNodeIds(PlayerColor.RED, true).stream().min(Integer::compare).orElseThrow();
        game.execute(new com.catanatron.core.model.Action<>(PlayerColor.RED, com.catanatron.core.model.ActionType.BUILD_SETTLEMENT, node));
        // Road (skip specifics)
        // Initial road must connect to last settlement; pick edge that touches node
        com.catanatron.core.model.Edge edge = game.state.board.buildableEdges(PlayerColor.RED).stream()
                .filter(e -> e.a() == node || e.b() == node)
                .findFirst().orElseThrow();
        game.execute(new com.catanatron.core.model.Action<>(PlayerColor.RED, com.catanatron.core.model.ActionType.BUILD_ROAD, edge));
    ...
    public void roadMustConnectToOwned() {
        ...
        game.execute(new com.catanatron.core.model.Action<>(PlayerColor.RED, com.catanatron.core.model.ActionType.BUILD_SETTLEMENT, node));
        com.catanatron.core.model.Edge legalEdge = game.state.board.buildableEdges(PlayerColor.RED).get(0);
        game.execute(new com.catanatron.core.model.Action<>(PlayerColor.RED, com.catanatron.core.model.ActionType.BUILD_ROAD, legalEdge));
        ...
        com.catanatron.core.model.Edge someEdge = new com.catanatron.core.model.Edge(Math.min(anyNode, neighbor), Math.max(anyNode, neighbor));
        ...
        game.execute(new com.catanatron.core.model.Action<>(PlayerColor.BLUE, com.catanatron.core.model.ActionType.ROLL, new int[]{3,4}));
        game.state.playerState.put("P1_WOOD_IN_HAND", 1);
        game.state.playerState.put("P1_BRICK_IN_HAND", 1);
        boolean thrown = false;
        try {
            game.execute(new com.catanatron.core.model.Action<>(PlayerColor.BLUE, com.catanatron.core.model.ActionType.BUILD_ROAD, someEdge));
    ...
    public void rollPaysOutResourcesAndRobberBlocks() {
        ...
        game.execute(new com.catanatron.core.model.Action<>(PlayerColor.RED, com.catanatron.core.model.ActionType.BUILD_SETTLEMENT, nodeId));
        com.catanatron.core.model.Edge edge = game.state.board.buildableEdges(PlayerColor.RED).stream()
        ...
        long contributing = game.state.map.getTileIdsByNumber(8).stream()
                .filter(id -> game.state.map.getTileNodes(id).contains(nodeId))
                .count();
        game.execute(new com.catanatron.core.model.Action<>(PlayerColor.RED, com.catanatron.core.model.ActionType.ROLL, new int[]{3,5}));
        int after = getRes(game, 0, res.name());
        assertEquals(before + (int)contributing, after, "settlement yield should match adjacent 8-tiles");

        // End turn so we can continue; directly enter MOVE_ROBBER for this test
        game.execute(new com.catanatron.core.model.Action<>(PlayerColor.RED, com.catanatron.core.model.ActionType.END_TURN, null));
        game.state.currentPrompt = ActionPrompt.MOVE_ROBBER;
        game.execute(new com.catanatron.core.model.Action<>(PlayerColor.RED, com.catanatron.core.model.ActionType.MOVE_ROBBER, tileId));
        ...
        assertEquals(before2 + (int)contributing - 1, after2, "robber should block payouts on that tile only");
    }
    ...
    public void robberStealsFromAdjacentVictim() {
        ...
        game.execute(new com.catanatron.core.model.Action<>(PlayerColor.RED, com.catanatron.core.model.ActionType.BUILD_SETTLEMENT, redNode));
        com.catanatron.core.model.Edge redEdge = game.state.board.buildableEdges(PlayerColor.RED).get(0);
        game.execute(new com.catanatron.core.model.Action<>(PlayerColor.RED, com.catanatron.core.model.ActionType.BUILD_ROAD, redEdge));
        ...
        for (Integer t : game.state.map.tilesById.keySet()) {
            if (game.state.map.getTileNodes(t).contains(nodeId)) { tileId = t; break; }
        }
        assertNotNull(tileId);

        // BLUE initial settlement at nodeId on chosen tile and a road
        game.execute(new com.catanatron.core.model.Action<>(PlayerColor.BLUE, com.catanatron.core.model.ActionType.BUILD_SETTLEMENT, nodeId));
        com.catanatron.core.model.Edge blueEdge = game.state.board.buildableEdges(PlayerColor.BLUE).stream()
                .filter(e -> e.a() == nodeId || e.b() == nodeId).findFirst().orElseThrow();
        game.execute(new com.catanatron.core.model.Action<>(PlayerColor.BLUE, com.catanatron.core.model.ActionType.BUILD_ROAD, blueEdge));
        ...
        game.execute(new com.catanatron.core.model.Action<>(PlayerColor.RED, com.catanatron.core.model.ActionType.ROLL, new int[]{3,4}));
        // Now in MOVE_ROBBER
        game.execute(new com.catanatron.core.model.Action<>(PlayerColor.RED, com.catanatron.core.model.ActionType.MOVE_ROBBER, tileId));
    ...
    public void yearOfPlentyGivesResourceAndKnightSetsMoveRobber() {
        ...
        game.execute(new com.catanatron.core.model.Action<>(PlayerColor.RED, com.catanatron.core.model.ActionType.PLAY_YEAR_OF_PLENTY, new String[]{"WOOD"}));
        ...
        game.execute(new com.catanatron.core.model.Action<>(PlayerColor.RED, com.catanatron.core.model.ActionType.PLAY_KNIGHT_CARD, null));
        assertEquals(ActionPrompt.MOVE_ROBBER, game.state.currentPrompt, "Knight should set MOVE_ROBBER");
    }
    ...
    public void yearOfPlentyTwoCardsGrantsBoth() {
        ...
        game.execute(new com.catanatron.core.model.Action<>(PlayerColor.RED, com.catanatron.core.model.ActionType.PLAY_YEAR_OF_PLENTY, new String[]{"WOOD","BRICK"}));
    ...
    public void yearOfPlentyTwoOfSameResourceGrantsTwo() {
        ...
        game.execute(new com.catanatron.core.model.Action<>(PlayerColor.RED, com.catanatron.core.model.ActionType.PLAY_YEAR_OF_PLENTY, new String[]{"WHEAT","WHEAT"}));
    ...
    public void roadBuildingPlacesTwoFreeRoads() {
        ...
        int node = game.state.board.buildableNodeIds(PlayerColor.RED, true).iterator().next();
        game.execute(new com.catanatron.core.model.Action<>(PlayerColor.RED, com.catanatron.core.model.ActionType.BUILD_SETTLEMENT, node));
        com.catanatron.core.model.Edge e1 = game.state.board.buildableEdges(PlayerColor.RED).stream()
                .filter(e -> e.a() == node || e.b() == node).findFirst().orElseThrow();
        game.execute(new com.catanatron.core.model.Action<>(PlayerColor.RED, com.catanatron.core.model.ActionType.BUILD_ROAD, e1));
        ...
        // Play Road Building
        game.execute(new com.catanatron.core.model.Action<>(PlayerColor.RED, com.catanatron.core.model.ActionType.PLAY_ROAD_BUILDING, null));
        ...
        game.execute(new com.catanatron.core.model.Action<>(PlayerColor.RED, com.catanatron.core.model.ActionType.BUILD_ROAD, r1));
        com.catanatron.core.model.Edge r2 = game.state.board.buildableEdges(PlayerColor.RED).get(0);
        game.execute(new com.catanatron.core.model.Action<>(PlayerColor.RED, com.catanatron.core.model.ActionType.BUILD_ROAD, r2));
    ...
    public void buyDevelopmentCardConsumesResourcesAndAddsToHand() {
        ...
        game.execute(new com.catanatron.core.model.Action<>(PlayerColor.RED, com.catanatron.core.model.ActionType.BUY_DEVELOPMENT_CARD, null));
        ...
        int inHandTotal = game.state.playerState.get("P0_KNIGHT_IN_HAND")
    ...
    public void monopolyTransfersAllOfResourceFromOpponents() {
        ...
        // Play Monopoly: WOOD
        game.execute(new com.catanatron.core.model.Action<>(PlayerColor.RED, com.catanatron.core.model.ActionType.PLAY_MONOPOLY, "WOOD"));
    ...
    public void largestArmyAwardsAndSwitchesOnLeadershipChange() {
        ...
        game.state.isInitialBuildPhase = false;
        for (int i=0;i<3;i++) {
            game.state.currentPlayerIndex = 0; game.state.currentTurnIndex = 0;
            game.state.currentPrompt = ActionPrompt.PLAY_TURN;
            // Ensure dev timing and in-hand; mark owned-at-start for playability this turn
            game.state.playerState.put("P0_KNIGHT_IN_HAND", game.state.playerState.get("P0_KNIGHT_IN_HAND") + 1);
            game.state.playerState.put("P0_KNIGHT_OWNED_AT_START", 1);
            game.state.playerState.put("P0_HAS_ROLLED", 1);
        ...
        for (int i=0;i<4;i++) {
            game.state.currentPlayerIndex = 1; game.state.currentTurnIndex = 1;
            game.state.currentPrompt = ActionPrompt.PLAY_TURN;
            game.state.playerState.put("P1_KNIGHT_IN_HAND", game.state.playerState.get("P1_KNIGHT_IN_HAND") + 1);
            ...
            game.execute(new com.catanatron.core.model.Action<>(PlayerColor.BLUE, com.catanatron.core.model.ActionType.PLAY_KNIGHT_CARD, null));
            Integer tileId = game.state.map.tilesById.keySet().iterator().next();
            game.execute(new com.catanatron.core.model.Action<>(PlayerColor.BLUE, com.catanatron.core.model.ActionType.MOVE_ROBBER, tileId));
            game.execute(new com.catanatron.core.model.Action<>(PlayerColor.BLUE, com.catanatron.core.model.ActionType.END_TURN, null));
        }
